...
namespace GamesSample
{
    ...
    /// </summary>
    public sealed partial class SplitPage : GamesSample.Common.LayoutAwarePage
    {
        public SplitPage()
        {
        ...
        void ItemListView_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            //ToastAlert("la selection a changé.");
            //ToastAlert2();
        }
        ...
        public static void ToastAlert(string message)
        {
            ...
            {
                textElements.Item(i).AppendChild(toastXml.CreateTextNode(message));
            }
        ...
        public static void ToastAlert2()
        {
